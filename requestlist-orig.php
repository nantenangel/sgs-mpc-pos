					...
					try {
						...
						for ($i=0;$i<$stmt->rowCount();$i++){
							if ($row = $stmt->fetch()){
								$id=$row['RequestID'];
								echo "<tr>";
								//echo "<td style='text-align:center;'><button class='btn btn-link' data-toggle='modal' data-target='#RequestInfo'>View Details</button></td>";
								echo "<td><a href=$id data-toggle='modal' data-target='#RequestInfo'>View Details</a></td>";
								echo "<td style='text-align:center;cursor:default;'>" . $row['RequestID'] . "</td>";
								echo "<td style='text-align:center;cursor:default;'>" . $row['RequestDate'] . "</td>";
								echo "<td style='text-align:center;cursor:default;'>" . $row['RequestStatus'] . "</td>";
								echo "</tr>";
							}
						}
						echo "</table>";
						
						echo "<div class='modal fade' id='RequestInfo' role='dialog'>
