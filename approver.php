			...
			<div class="panel-body">
				...
				<table class='table table-bordered'>
					<thead>
					    ...
					    <th class='col-md-1' style='text-align:center;cursor:default;'>Request ID</th>
					    <th class='col-md-2' style='text-align:center;cursor:default;'>Request Date</th>
						...
						if ($row = $stmt->fetch()){
							...
							<tr>
								...
								<td style='text-align:center;'>
									...
									<button class="btn btn-warning">Remarks</button>
								</td>							   
							</tr>
				<?php }
					}
